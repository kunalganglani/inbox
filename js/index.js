...
$('#alphaSort').data("sortKey", "p.title");
$('#dateSort').data("sortKey", "p.title");

$('#alphaSort').on('click',function(){
sortUsingNestedText($('#main-nano-wrapper ul'), "li", $(this).data("sortKey"));
});
...
$('div input').keyup(function(t) {
 var filter = $(this).val();
 
        // Loop through the comment list
        $("#main-nano-wrapper li p").each(function(){
 
